...
// Camera
Camera camera( glm::vec3( 15.0f, 0.0f, 3.0f ),glm::vec3(0.0f,1.0f,0.0f),180.0f);
bool keys[1024];
...
int main( )
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //glUniform3f(glGetUniformLocation(fresnel.Program, "lightDir"),camera.GetPosition().x, camera.GetPosition().y, camera.GetPosition().z);
